...
class LanguageFr extends Languages {
  ...
  //signin
  @override String get labelSignin => "Se connecter";
  @override String get labelContinueGoogle => "Continuer avec Google";
  @override String get labelContinueFacebook => "Continuer avec Facebook";
  @override String get labelContinueApple => "Continuer avec Apple";
  @override String get labelOr => "ou";
  //signup
  @override String get labelSignup => "S'inscrire";
  @override String get labelPhone => "Numero de téléphone";
  @override String get labelPassword => "Mot de passe";
  @override String get labelForgotPassword => "Forgot Passoword?";
  @override String get labelPlaceholderPhoneNumber => "Entrez votre numéro de téléphone";
  @override String get labelPlaceholderPassword => "Entrez votre mot de passe";
  @override String get labelPasswordConfirm => "Confirmation de mot de passe";
  @override String get labelPlaceholderPasswordConfirm => "Confirmer votre mot de passe";
  @override String get labelPhonePasswordError => "Numéro ou mot de passe incorrecte";
  @override String get labelFullName => "Nom complet";
  @override String get labelPlaceholderFullName => "Entrez votre nom complet";
  @override String get labelEmail => "Email";
  @override String get labelPlaceholderEmail => "Entrez votre Email";
  @override String get labelCheckAllFields => "Vérifiez tous les champs";
  @override String get labelNumberAlreadyExist => "Ce numéro existe déja";
  @override String get textAlreadyRegistered => "déja inscrit?";
  @override String get textToLogin => "Se connecter";
  //OTP
  @override String get labelOtp => "Enter OTP";
  @override String get labelContinue => "Continue";
  @override String get labelContinueOnHomepage => "Continuer sur la page d\'accueil";
  ...
  @override String get textRegisteredSuccess => "Inscription réussite";
  @override String get textPhoneRegisteredSuccess => "Votre numéro de téléphone a été enregistré avec succès.";
  ...
  @override String get textNoAccount => "Pas encore de compte?";
